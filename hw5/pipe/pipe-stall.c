...
long long gen_mem_byte()
{
    return (((if_id_next->icode) == (I_MRMOVQ) || (if_id_next->icode) == 
        (I_RMMOVQ)) ? (if_id_next->ifun) : 0);
}
...
{
    return ((((I_RET) == (if_id_curr->icode) || (I_RET) == 
...
{
    return (((((id_ex_next->srca) != (REG_NONE)) & ((id_ex_next->srca) == 
            (ex_mem_next->deste) || (id_ex_next->srca) == 
            (id_ex_curr->destm) || (id_ex_next->srca) == 
            (ex_mem_curr->destm) || (id_ex_next->srca) == 
            (ex_mem_curr->deste) || (id_ex_next->srca) == 
          ...
          ((id_ex_next->srcb) == (ex_mem_next->deste) || (id_ex_next->srcb)
            ...
            (mem_wb_curr->deste)))) & !(((id_ex_curr->icode) == (I_JMP)) & 
        !(ex_mem_next->takebranch)));
}
